  ...
  return (
    ...
    >
      <div className="dashboard-compact-header">
        <div>
          <h2 className="dashboard-compact-title">Your top 3 stones</h2>
          <p className="dashboard-compact-subtitle">Most frequently purchased</p>
        </div>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ gap: '1rem' }}>
